// LoopHero_KCH.cpp : 애플리케이션에 대한 진입점을 정의합니다.
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_LOOPHEROKCH, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LOOPHEROKCH));
    ...
    while (true)
    {
        ...
        {
            // 게임 실행
            ch::Application::GetInstance().Tick();
        }
    }
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LOOPHEROKCH));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LOOPHEROKCH);
